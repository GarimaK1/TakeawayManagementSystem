...
CREATE TABLE IF NOT EXISTS `DMDD_Project_Garima`.`employee_professional` (
  ...
  `salary(per month)` DECIMAL NOT NULL,
...
-- -----------------------------------------------------
-- Table `DMDD_Project_Garima`.`ingredients`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DMDD_Project_Garima`.`ingredients` (
  `ingred_id` INT NOT NULL AUTO_INCREMENT,
  `ingred_name` VARCHAR(45) NOT NULL,
  `ingred_threshold` DECIMAL NOT NULL,
  `current_inventory_level` DECIMAL NULL,
  `ingred_cost` DECIMAL NOT NULL,
...
-- -----------------------------------------------------
-- Table `DMDD_Project_Garima`.`menu_ingred`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DMDD_Project_Garima`.`menu_ingred` (
  `menu_id` INT NOT NULL,
  `ingred_id` INT NOT NULL,
  `qty_used_per_menu_item` INT NOT NULL,
  PRIMARY KEY (`menu_id`, `ingred_id`),
  INDEX `FK_ingred_id_idx` (`ingred_id` ASC) VISIBLE,
  CONSTRAINT `FK_menu_item_id`
    FOREIGN KEY (`menu_id`)
    REFERENCES `DMDD_Project_Garima`.`menu_item` (`menu_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_ingred_id`
    FOREIGN KEY (`ingred_id`)
    REFERENCES `DMDD_Project_Garima`.`ingredients` (`ingred_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DMDD_Project_Garima`.`supplier_list`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DMDD_Project_Garima`.`supplier_list` (
...
-- -----------------------------------------------------
-- Table `DMDD_Project_Garima`.`ingred_supplies`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DMDD_Project_Garima`.`ingred_supplies` (
  `ingred_id` INT NOT NULL,
  `supplier_id` INT NOT NULL,
  `supplies_at_price` DECIMAL NOT NULL,
  `min_quantity_supplied` DECIMAL NOT NULL,
  PRIMARY KEY (`ingred_id`, `supplier_id`),
  INDEX `FK_ingred_supplier_id_idx` (`supplier_id` ASC) VISIBLE,
  CONSTRAINT `FK_supp_ingred_id`
    FOREIGN KEY (`ingred_id`)
    REFERENCES `DMDD_Project_Garima`.`ingredients` (`ingred_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_ingred_supplier_id`
    FOREIGN KEY (`supplier_id`)
    REFERENCES `DMDD_Project_Garima`.`supplier_list` (`supplier_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
